...
public class ReceiveRewardEvent extends ApplicationEvent {
    private Long uid;
    private Long hisUid;
    ...
    public ReceiveRewardEvent(Object source, Long uid, Long hisUid, String hisNickname, Long rewardResourceId, String rewardResourceName, Integer amount, Long diamonds, Long transactionalDiamonds, String orderId) {
        super(source);
        this.uid = uid;
        this.hisUid = hisUid;
