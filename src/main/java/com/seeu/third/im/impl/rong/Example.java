package com.seeu.third.im.impl.rong;

import com.seeu.third.im.impl.rong.messages.TxtMessage;
import com.seeu.third.im.impl.rong.messages.VoiceMessage;
import com.seeu.third.im.impl.rong.models.*;
import com.seeu.third.im.impl.rong.util.GsonUtil;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "82hegw5u8do0x";//替换成您的appkey
		String appSecret = "r3vRinueMBjSf1";//替换成匹配上面key的secret
